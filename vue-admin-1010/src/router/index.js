...
export const constantRouterMap = [
    ...
    children: [
      {
        ...
        meta: { title: '学生成绩查询', icon: 'table' }
      },
      {
        path: 'add',
        name: '成绩分段查询',
        component: () => import('@/components/teacher/selectExamToPart'),
        meta: { title: '成绩分段查询', icon: 'table' }
      },
      {
        path: 'grade',
...

  {
    path: '/student',
    component: Layout,
    redirect: '/teacher/studentManage',
    name: '学生管理',
